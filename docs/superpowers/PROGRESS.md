...
| 4    | Audio real (captura/reproducción, AudioStream PCM, enumeración de dispositivos)                          | 🟡 implementada (`phase-4`, pendiente review/merge) |
...
- Fase 4: audio real (rama `phase-4`, pendiente review/merge). `@murmur/audio`: `pcm.ts`
